...
import ahorcado_2.pkg0.PRINCIPAL_CONECCION;
...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String resultado="Vamos a ver ";
        String sql = "INSERT INTO" + " JUGADOR (NOMBRE,RESULTADO)"+" VALUES(?,?)"; 
        try{
         Sentencia= PRINCIPAL_CONECCION.Conexion.prepareStatement(sql);
         Sentencia.setString(1,TXT_NOMBRE.getText());
         Sentencia.setString(2,resultado);
         Sentencia.executeUpdate();
         System.out.println("GUardado");
         System.out.println(sql); 
         Sentencia.close();
         AHORCADO_INTERFACE  From=new AHORCADO_INTERFACE (); 
